...
import { AdBannerPlaceholder, SideAdBanners } from "../components/ad-banner";
    ...
    <>
      <div className="min-h-screen bg-[#FAFAFA] flex flex-col relative">
        ...
        <SideAdBanners
          ...
          bannerWidth={160}
          bannerHeight={660}
          anchorId="featured-top"
        />

        <main className="flex-grow">
          <div className="max-w-5xl mx-auto px-4 py-4">
            {/* Featured Story Card */}
            <section id="featured-top" className="mb-16">
              <div
                className={`grid grid-cols-1 ${
                  shouldShowTrending ? "lg:grid-cols-3" : "lg:grid-cols-1"
                } gap-8`}
              >
                {/* Main Featured Story Card */}
                <div
                  className={
                    shouldShowTrending ? "lg:col-span-2" : "lg:col-span-1"
                  }
                >
                  {featuredStory ? (
                    <Link
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {moreStories?.slice(0, 9).map((story, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`${bgColor} border-2 border-[#1a1a1a] shadow-[3px_3px_0px_0px_rgba(26,26,26,0.2)] hover:shadow-[5px_5px_0px_0px_rgba(26,26,26,0.2)] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all duration-200 overflow-hidden`}
                        >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4">
                <div>
                  ...
                  <p className="text-[#1a1a1a]/50 text-xs">
                    Stay updated with the most recent news and insights
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {latestStories?.map((story, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`${bgColor} border-2 border-[#1a1a1a] shadow-[3px_3px_0px_0px_rgba(26,26,26,0.2)] hover:shadow-[5px_5px_0px_0px_rgba(26,26,26,0.2)] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all duration-200 h-full overflow-hidden`}
                        >
